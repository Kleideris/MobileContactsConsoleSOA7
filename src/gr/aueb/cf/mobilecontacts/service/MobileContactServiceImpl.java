...
public class MobileContactServiceImpl implements IMobileContactService {
    ...
    public MobileContact getContactById(Long id) throws ContactNotFoundException {
        ...
        try {
            ...
            System.err.printf("MobileContactServiceImpl Logger: Contact with id: %d not found to get returned\n", id);
            throw  e;
        }
    }
    ...
    public MobileContact getContactByPhoneNumber(String phoneNumber) throws ContactNotFoundException {
        ...
        try {
            ...
            System.err.printf("MobileContactServiceImpl Logger: Contact with phone number: %s not found to get returned\n", phoneNumber);
            throw  e;
        }
    }
    ...
    public void deleteContactByPhoneNumber(String phoneNumber) throws ContactNotFoundException {
        try {
            if (!dao.phoneNumberExists(phoneNumber)) {
                throw new ContactNotFoundException("Contact with phoneNumber: " + phoneNumber + " not found for delete.");
            }
            System.err.printf("MobileContactServiceImpl Logger: contact with phoneNumber: %s was deleted.\n", phoneNumber);
